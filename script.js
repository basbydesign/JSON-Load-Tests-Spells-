...
function populateSpells(obj) {
  ...
  for (const spell of spells) {
    ...
    myPara2.textContent = `Casting Time: ${castingtime}`;
    myPara3.textContent = `Range: ${range}`;
    myPara4.textContent = `Duration: ${duration}`;
    myPara5.textContent = `Ritual: ${ritual}`;
    myPara6.textContent = `Components: ${verbal}`;
    myPara7.textContent = `Materials: ${materials}`;
    myPara8.textContent = `Description: ${description}`;
